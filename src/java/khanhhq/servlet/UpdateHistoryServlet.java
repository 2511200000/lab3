...
public class UpdateHistoryServlet extends HttpServlet {
    ...
    private final String DATA = "PrintHistoryServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idHistory = request.getParameter("txtHistoryID");
        int historyID = Integer.parseInt(idHistory);
        String url = DATA;
        try {
            /* TODO output your page here. You may use following sample code. */
            TblHistoryRentalDAO dao = new TblHistoryRentalDAO();
            boolean result = dao.updateHistory(historyID);
            if (result) {
                url = DATA;
            }
